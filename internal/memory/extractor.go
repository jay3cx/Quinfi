...
4. **不要提取持仓信息**（如"持有某基金"、"买入/卖出某基金"、"持仓金额"等），持仓由专门的持仓管理模块处理
5. 重要性(importance)评分标准：
   - 0.8-1.0: 重大投资决策意向、风险事件
...
- fact: 投资事实（投资决策理由、市场判断等，**不包括具体持仓**）
...
[
  {"type": "profile", "content": "用户风险偏好中等，偏好稳健型基金", "importance": 0.8},
